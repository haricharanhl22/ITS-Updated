...
_Generated: 2026-06-06T14:46:51.614Z_
...
Workspace `mcp.json` _(folder: HCAI-ITS)_

- **c:\Users\91779\Desktop\AMS\HCAI-ITS\.vscode\mcp.json** — _File missing_
...
- **pinokio** — `C:\Users\91779\.claude\skills\pinokio`
  - Discover, launch, and use apps and tools for the current task.

- **pinokio** — `C:\Users\91779\.agents\skills\pinokio`
  - Discover, launch, and use apps and tools for the current task.
